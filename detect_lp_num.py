...
def detect_lp(opt, model, model_1, half, webcam, device):
...
def set_model(save_img=False):
    ...
    detect_lp(opt=opt, model=model_0, model_1=model_1, half=half, webcam=webcam, device=device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights_1', nargs='+', type=str, default='weights/lp_num_best_b.pt', help='model.pt path(s)')
